      ...
      <div className="py-10 bg-white">
        ...
        >
          <div className="text-center mb-6 max-w-[400px] mx-auto">
            <p className="text-lg bg-clip-text  text-gray-600 ">
              {collectionn == "" ? "Menu is Loading..." : "Our Menu"}
            </p>
            <h1 className="text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-[#fbbf24] to-[#d97706]">
              Services
            </h1>
          ...
          <div className="justify-center gap-2 flex text-center mb-4">
            <button
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap text-center">
