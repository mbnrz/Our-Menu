  ...
  return (
    <>
      <footer className="footer p-10 bg-neutral text-base-content ">
        <nav>
          <header className="footer-title text-gray-400">Services</header>
        ...
        <nav>
          <header className="footer-title text-gray-400">Company</header>
        ...
        <nav>
          <header className="footer-title text-gray-400">Legal</header>
